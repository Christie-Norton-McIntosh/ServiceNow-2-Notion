...
// Mock HTML from real Procurement page (standalone UL with related links)
const testHtml = `
<!DOCTYPE html>
<html>
<body>
  <div class="zDocsTopicPageBody">
    <article>
      ...
      <!-- Standalone UL with related content (real structure) -->
      <ul><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/reference/r_ProcurementRoles.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Procurement roles</a><p>The Procurement application uses the following roles.</p></li><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/concept/c_ProcurementWorkflows.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Procurement workflows</a><p>Procurement uses the following workflows.</p></li><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/task/t_UsingTheProcurementOverviewModule.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Use the Procurement Overview module</a><p>Use the gauges on the Procurement Overview homepage to help you track and manage requests, purchase orders, and other important aspects of the procurement process.</p></li><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/concept/c_SourcingRequestItems.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Sourcing items in a service catalog request</a><p>A service catalog request can contain multiple items that must be sourced.</p></li><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/concept/c_UseProcurement.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Procurement purchase order management for assets</a><p>Accurate purchase order information is important for invoice tracking, receiving, and reporting in the ServiceNow platform.</p></li><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/concept/c_ReceiveAssets.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Receive assets</a><p>Assets can be received and added to the system when they are delivered to a stockroom.</p></li><li><a class=" css-ettsdk" stylesprops="[object Object]" href="/docs/bundle/yokohama-it-service-management/page/product/procurement/concept/domain-separation-procurement.html"><svg class="ico-related-link" aria-hidden="true"><use xlink:href="#ico-related-link"></use></svg>Domain separation and Procurement</a><p>Domain separation is supported in Procurement processing. Domain separation enables you to separate data, processes, and administrative tasks into logical groupings called domains. You can control several aspects of this separation, including which users can see and access data.</p></li></ul>
    </article>
  </div>
</body>
</html>
